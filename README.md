...
```javascript
import regexp from 'https://cdn.jsdelivr.net/gh/stdlib-js/regexp@v0.4.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/regexp/actions/workflows/test.yml/badge.svg?branch=v0.4.1
[test-url]: https://github.com/stdlib-js/regexp/actions/workflows/test.yml?query=branch:v0.4.1
